    ...
    findLikers: function (postID, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const findLikersQuery = `SELECT user.* FROM user, likes where likes.fk_user_id = user.id and likes.fk_post_id = ?`;
    ...
    findLikersByPostIDs: function (postIDs, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const findLikersQuery = `SELECT user.*, likes.fk_post_id FROM user, likes WHERE likes.fk_user_id = user.id AND likes.fk_post_id IN (?);`;
