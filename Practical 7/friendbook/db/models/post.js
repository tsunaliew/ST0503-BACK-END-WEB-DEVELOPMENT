    ...
    findByUserID: function (userID, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const findByUserIDQuery = `SELECT * FROM post WHERE fk_poster_id = ? ORDER BY created_at DESC;`;
    ...
    findByID: function (postID, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const findByIDQuery = `SELECT * FROM post WHERE id = ?;`;
    ...
    insert: function (post, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                dbConn.query(
                    insertQuery,
                    [post.text_body, post.fk_poster_id],
                    (error, results) => {
                        dbConn.end();
                        if (error) {
                            return callback(error, null);
    ...
    edit: function (postID, post, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const editPostQuery = `UPDATE post SET text_body = ? WHERE id = ?;`;
                dbConn.query(
                    editPostQuery,
                    [post.text_body, postID],
                    (error, results) => {
                        if (error) {
    ...
    like: function (postID, likerID, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const likeQuery = `INSERT INTO likes (fk_user_id, fk_post_id) VALUES (?, ?); `;
    ...
    unlike: function (postID, likerID, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const likeQuery = `DELETE FROM likes WHERE fk_user_id = ? AND fk_post_id = ?;`;
                dbConn.query(likeQuery, [likerID, postID], (error, results) => {
                    if (error) {
                        return callback(error);
                    }
    ...
    findLikers: function (postID, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const findLikersQuery = `SELECT user.id, user.full_name, user.username, user.bio, user.date_of_birth, user.created_at 
                FROM user 
    ...
    findLikersByPostIDs: function (postIDs, callback) {
        ...
        dbConn.connect(function (err) {
            if (err) {
                ...
                const findLikersQuery = `SELECT user.id, user.full_name, user.username, user.bio, user.date_of_birth, user.created_at, likes.fk_post_id 
                FROM user, likes 
